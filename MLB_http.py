...
class MLBStatsResponse(Orihttp.Ori_Response):
...
class MLBStatsHTTP(Orihttp.Ori_HTTP):

    nba_response = MLBStatsResponse

    base_url = 'http://statsapi.mlb.com/api/v1/{endpoint}'
